#ifndef __STAT_FUNC__UNIQ__H
#define __STAT_FUNC__UNIQ__H
...
#include "stat_win.h"
class stat_func_count_uniq : public stat_func
{
public:
	char *_name;
	stat_func_count_uniq(char *name = NULL);
	~stat_func_count_uniq();
	...
	std::string min_len_string(stat_win_fac<stat_win_S * > &fac);
