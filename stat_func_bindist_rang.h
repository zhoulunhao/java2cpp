#ifndef __STAT_FUNC_BINDIST_RANGE__H
#define __STAT_FUNC_BINDIST_RANGE__H
...
class stat_func_bindist_rang : public stat_func
{
public:
	char *_name;
	stat_func_bindist_rang(char *name = NULL);
	~stat_func_bindist_rang();
